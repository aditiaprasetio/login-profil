<?php
/*************************************************************
 bikubiku PHP XML Sitemap Generator
 Simple site crawler to create a search engine XML Sitemap.
 Version 1.0
 Free to use, without any warranty.
 Written by bikubiku(Hemn Chawroka) http://bikubiku.id 28/Mar/2016.
...
*************************************************************/
	...
	// SSL websites.
	$start_url_new[] = "https://bikubiku.id";       
	$start_url_new[] = "https://bikubiku.id/blog";     
	$start_url_new[] = "https://bikubiku.id/ilmu";     
	...
	// Example: "http://bikubiku.id/print" will also skip
	// http://bikubiku.id/print/bootmanager.html
	$skip = array (
					"http://bikubiku.id/page/tambah","http://bikubiku.id/artikel/tambah",
				  );
	...
	function GetUrl ($url) {
		$agent = "Mozilla/5.0 (compatible; bikubiku PHP XML Sitemap Generator/" . VERSION . ", https://bikubiku.id)";
	...
	$start_url_new[0] = filter_var ($start_url_new[0], FILTER_SANITIZE_URL);

	fwrite ($pf, "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" .
				 "<?xml-stylesheet type=\"text/xsl\" href=\"http://bikubiku.github.io/PHP-XML-Sitemap-Generator/xml-sitemap.xsl\"?>\n" .
				 "<!-- Created with bikubiku PHP XML Sitemap Generator " . VERSION . " http://bikubiku.id -->\n" .
				 "<urlset xmlns=\"http://www.sitemaps.org/schemas/sitemap/0.9\"\n" .
				 "        xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"\n" .
				 "        xsi:schemaLocation=\"http://www.sitemaps.org/schemas/sitemap/0.9\n" .
				 "        http://www.sitemaps.org/schemas/sitemap/0.9/sitemap.xsd\">\n" .
				 "  <url>\n" .
				 "    <loc>" . htmlentities ($start_url_new[0]) ."</loc>\n" .
				 "    <changefreq>$freq</changefreq>\n" .
				 "    <priority>$priority</priority>\n" .
				 "  </url>\n");

	$scanned = array ();
	foreach($start_url_new as $key=>$start_url){
